...
| Commande | Avatar | Fonction |
|----------|--------|----------|
| **cd** | 🚚 Le Transporteur | Permet de se déplacer entre les pièces (dossiers) |
| **ls** | 📡 Le Scanner | Scanne la pièce actuelle et énumère ce qu'il y a dedans |
| **cat** | 📖 Le Lecteur | Lit le contenu d'un fichier pour découvrir son message |
| **grep** | 🔍 Le Chercheur | Fouille un fichier pour trouver une phrase ou un motif spécifique |
...
![échange sur le recyclage](https://durondil-blog.any-app.fr/storage/durondil_blog/recycle.jpg)
...
![En plein jeux](https://durondil-blog.any-app.fr/storage/durondil_blog/escape2.jpg)
...
![le matériel reconditionné](https://durondil-blog.any-app.fr/storage/durondil_blog/pc.jpg)
